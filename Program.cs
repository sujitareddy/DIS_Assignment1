...
namespace DIS_ASSIGNMENT1
{
    class Program
    {
        ...
        */
        ...
        /*  time taken - 1.5hrs. Firstly, I tried writing without using predefined functions. Using
         * predefined functions optimized the code. Should try writing the code without using predefined
         * function with lower time complexity
         */
       ...
       */
        ...
        /* This took me 1 hr. It was relatively easy as I used predefined function
         * 
         */
        ...
        private static bool ArrayStringsAreEqual(string[] bulls_string1, string[] bulls_string2)
        {
            try
            {
                ...
                string first_string = string.Join("" , bulls_string1);
                string second_string = string.Join("" , bulls_string2);
        ...
        */
        ...
        /* This took me 2hrs. Should have written optimized code as time complexity is way too high 
            for this problem */ 
...

        {
            try
            {
                ...
                List<int> bucks = bull_bucks.ToList();
                ...
                foreach (var dict_value in dict)
                {
                    if (dict_value.Value == 1)
        ...
        */
        ...
        /*  This took me 1.5 hrs. I think this code is fairly optimised
         *
         */
        private static int DiagonalSum(int[,] bulls_grid)
        {
            try
            {
                ...
                for (int i = 0; i < len; i++)
                {
                   count += bulls_grid[i, i];
                    count += bulls_grid[i, len - i - 1];
                }

                if (len % 2 == 0)
                    return count;
                int repeated = bulls_grid[len / 2, len / 2];
        ...
        */
        ...
        /* This took me 1.5hrs. I tried writing the code without using Index method, but the 
         * code was a bit lengthy. So I decided to use the function.
         */
        ...
        private static string RestoreString(string bulls_string, int[] indices)
        {
            ...
            try
            {
                ...
                String final_string= "";
                while (len < bulls_string.Length)
                {

                    index = Array.IndexOf(indices, len);
                    final_string = final_string + bulls_string[index];
                    len = len + 1;
                }
                return final_string;
        ...
        */
        ...
        /* This took me 1.5hrs . Should've written a more optimised code
         * 
         */
        ...
        private static string ReversePrefix(string bulls_string6, char ch)
        {
            try
            {
                ...
                for (int i = index + 1; i < bulls_string6.Length; i++)
                {
                    prefix_string += bulls_string6[i];
                }
